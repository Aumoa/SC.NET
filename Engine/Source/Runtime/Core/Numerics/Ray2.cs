...
namespace SC.Engine.Runtime.Core.Numerics
{
    ...
    /// 2차원 광선 정보를 정의합니다.
    /// </summary>
    public struct Ray2 : INearlyEquatable<Ray2, float>, IFormattable
    {
        /// <summary>
        /// 광선의 시작 위치를 나타냅니다.
        /// </summary>
        ...
        /// <summary>
        /// 모든 값을 지정하여 <see cref="Ray2"/> 구조체의 새 인스턴스를 초기화합니다.
        /// </summary>
        ...
        public Ray2(Vector2 origin, Vector2 direction, float? distance = null)
        {
            Origin = origin;
            Direction = direction;
            Distance = distance;
        ...
        /// <summary>
        /// 광선이 대상 사각형 내부를 통과하는지 검사합니다. 통과할 경우 최초 통과 지점까지 가는 광선의 거리가 반환됩니다.
        /// </summary>
        /// <param name="rect"> 사각형을 전달합니다. </param>
