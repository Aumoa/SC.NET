...
namespace SC.Engine.Runtime.GameFramework.Components
{
    ...
    public class SSceneComponent : SActorComponent
    {
        ...
        {
            this.Log(Error, $"Cannot found socket from target component with socket name: {socketName}.");
            return Transform.Identity;
        }
        ...
        public void DetachFromComponent()
        {
            ...
            if (indexOf == -1)
            {
                this.Log(Error, "Cannot found this component from attach parent component.");
                return;
            }
            else
            {
        ...
        void UpdateWorldTransform()
        {
            ...
            {
                this.Log(Error, $"Component try to move but mobility is not movable(Current: {_mobility}). Abort.");
                return;
            }
        ...
        public ComponentMobility Mobility
        {
            ...
            set
            {
                ...
                {
                    this.Log(Error, "The mobility cannot be changed when gameplay has been start.");
                    return;
                }
