...
{
    /// <summary>
    /// 여러 개의 위젯을 수평 규칙에 맞게 배열하는 컨테이너입니다.
    /// </summary>
    public class SHorizontalBoxPanel : SBoxPanel
    {
        /// <summary>
        /// 개체를 초기화합니다.
        /// </summary>
        public SHorizontalBoxPanel() : base(Orientation.Horizontal)
        {
        }

        /// <summary>
        /// <see cref="SHorizontalBoxPanel"/> 위젯의 슬롯을 표현합니다.
        /// </summary>
        public new class SSlot : SBoxPanel.SSlot
        {
            ...
            public SSlot(SHorizontalBoxPanel owner) : base(owner)
            {
            }
            ...
            /// <returns> 작업 체인이 반환됩니다. </returns>
            public new SHorizontalBoxPanel Init(HorizontalAlignment? HAlignment = null, VerticalAlignment? VAlignment = null, SizeParam SizeParam = null, Margin? SlotPadding = null, float? MaxSize = null)
            {
                return base.Init(HAlignment, VAlignment, SizeParam, SlotPadding, MaxSize) as SHorizontalBoxPanel;
            }
        }
