...
namespace SC.ThirdParty.DirectX
{
    ...
    public struct D3D11Viewport
	{
		...
		/// <summary>
		/// <see cref="D3D11Viewport"/> 구조체의 새 인스턴스를 초기화합니다.
		/// </summary>
		...
		public D3D11Viewport( float left, float top, float right, float bottom )
		{
			this.TopLeftX = left;
			this.TopLeftY = top;
		...
		public D3D11Viewport( float width, float height )
		{
			this.TopLeftX = 0;
			this.TopLeftY = 0;
			this.Width = width;
