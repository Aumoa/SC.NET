...
namespace SC.ThirdParty.DirectX
{
    ...
    /// </summary>
    public struct D3D12InputElementDesc
	{
		/// <summary>
		/// 의미소 이름을 나타냅니다.
		/// </summary>
		...
		/// <summary>
		/// <see cref="D3D12InputElementDesc"/> 구조체의 새 인스턴스를 초기화합니다.
		/// </summary>
		...
		public D3D12InputElementDesc( string name, DXGIFormat format, uint offset )
		{
			...
			this.InputSlotClass = D3D12InputClassification.PerVertexData;
