...
namespace SC.ThirdParty.DirectX
{
    ...
    /// </summary>
    public struct D3D12CPUDescriptorHandle
	{
		/// <summary>
		/// 서술자 핸들의 위치를 나타냅니다.
		/// </summary>
		...
		/// <summary>
		/// <see cref="D3D12CPUDescriptorHandle"/> 구조체의 새 인스턴스를 초기화합니다.
		/// </summary>
		/// <param name="ptr"> 핸들의 위치를 전달합니다. </param>
		public D3D12CPUDescriptorHandle( IntPtr ptr )
		{
			this.ptr = ptr;
		}
		...
		public void Offset( uint stride, int offset )
		{
			...
			ptr = new IntPtr( ptr.ToInt64() + delta );
		}
